...
def scheduler():
    ...
    try:
        ...
        try:
            ...
            obj = Solar_energy.objects.latest('time') #if the transaction is not approved after 2 minutes make a new transaction with the same values as the last db object created
